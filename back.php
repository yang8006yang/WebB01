...
<body>
	...
	<div id="main">
		<a title="<?=$TITLE->find(['sh'=>1])['text'];?>" href="?" alt="<?=$TITLE->find(['sh'=>1])['text'];?>">
			<div class="ti" alt="<?=$TITLE->find(['sh'=>1])['text'];?>" style="background:url('./upload/<?=$TITLE->find(['sh'=>1])['img'];?>'); background-size:cover;"></div>
		</a>
		<div id="ms">
